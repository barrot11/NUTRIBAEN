...
export default function Contact() {
  ...
  return (
    <section id="contacte" className="py-20 md:py-28 bg-neutral-warm-50/50 overflow-hidden">
      <div className="max-w-3xl mx-auto px-6 flex flex-col gap-10 md:gap-14">
        
        {/* Header - "primer contcata amb mi el text" */}
        <div className="text-center max-w-2xl mx-auto" id="contact-header">
          ...
          <p className="font-sans text-sm text-neutral-warm-500 font-light">
            Deixa'm les teves dades i et respondré en menys de 24 hores laborables.
          </p>
        </div>

        {/* Formulari - "i llavors despres d'aixo vull que ujois el formulari aqui" */}
        <div className="bg-white border border-neutral-warm-200/50 rounded-3xl p-6 md:p-10 shadow-[0_4px_25px_rgba(0,0,0,0.01)] relative min-h-[450px]">
        ...
        {/* Sota el formulari - "la ubicaio els links i el mapa" */}
        <div className="flex flex-col gap-6" id="contact-location-map-links">
          
          <div className="flex flex-col sm:flex-row gap-4 items-stretch justify-between">
            {/* Ubicació Card */}
            <div className="flex-1 flex items-start gap-4 p-5 bg-white border border-neutral-warm-200/50 rounded-2xl shadow-sm text-left">
              <div className="p-3 bg-brand-50 rounded-xl text-brand-600 mt-0.5 shrink-0">
                <MapPin className="h-5 w-5" />
              </div>
              <div>
                <span className="font-sans text-[10px] text-neutral-warm-400 uppercase tracking-wider block font-bold">
                  Consulta presencial
                </span>
                <address className="font-sans font-bold text-sm text-neutral-warm-800 not-italic mt-1 block leading-relaxed">
                  Carrer d'Agustí Duran i Santpere, 9<br />
                  25001 Lleida, España
                </address>
                <span className="font-sans font-light text-xs text-neutral-warm-400 block mt-1">
            ...
            {/* Links / Socials Block */}
            <div className="flex flex-col justify-center items-center sm:items-start p-5 bg-white border border-neutral-warm-200/50 rounded-2xl shadow-sm gap-3 min-w-[180px]">
              <span className="font-sans text-[10px] text-neutral-warm-400 uppercase tracking-wider font-bold">
                Xarxes socials
              </span>
              <div className="flex gap-3">
                <a
                  ...
                  className="p-3 bg-white border border-neutral-warm-200 text-neutral-warm-600 hover:text-brand-600 hover:border-brand-200 rounded-xl shadow-sm transition-all flex items-center justify-center group"
                  title="Instagram"
                >
                ...
                <a
                  ...
                  title="TikTok"
                >
                  <Tiktok className="h-5 w-5 group-hover:scale-110 transition-transform" />
                </a>
              </div>
            </div>
          </div>
          ...
          {/* Mapa */}
          <div className="rounded-2xl overflow-hidden border border-neutral-warm-200/60 shadow-inner h-64 sm:h-80 w-full">
            <iframe
